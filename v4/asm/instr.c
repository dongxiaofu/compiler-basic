...
int oprandIndex = 0;
	...
	instr->oprands[oprandIndex++] = oprand;
...
int oprandIndex = 0;
	...
	instr->oprands[oprandIndex++] = opr1;

	instr->oprands[oprandIndex++] = opr2;
...
int oprandIndex = 0;
	...
	instr->oprands[oprandIndex++] = src;

	instr->oprands[oprandIndex++] = dst;
