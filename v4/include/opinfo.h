...
OPINFO(OP_EQUAL,3,"==",      Binary,     NOP)
OPINFO(OP_NOT_EQUAL,3,"!=",      Binary,     NOP)
OPINFO(OP_LESS,3,"<",      Binary,     NOP)
OPINFO(OP_LESS_OR_EQUAL,3,"<=",      Binary,     NOP)
OPINFO(OP_GREATER,3,">",      Binary,     NOP)
OPINFO(OP_GREATER_OR_EQUAL,3,">=",      Binary,     NOP)
OPINFO(OP_ADD,4,"+",      Binary,     NOP)
OPINFO(OP_MINUS,4,"-",      Binary,     NOP)
OPINFO(OP_BINARY_BITWISE_OR,4,"|",      Binary,     NOP)
OPINFO(OP_BINARY_BITWISE_XOR,4,"^",      Binary,     NOP)
